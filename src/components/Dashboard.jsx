    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, index) => {
          ...
          return (
            <div key={index} className="bg-space-light/50 rounded-lg p-4 border border-white/10">
          ...
          {quickActions.map((action, index) => {
            ...
            return (
              <button
                ...
                className="bg-space-light/50 rounded-lg p-6 border border-white/10 hover-glow transition-all text-left group"
              >
      ...
      {userTokens.length > 0 && (
        <div>
          <h3 className="text-xl font-semibold text-white mb-4">Your Tokens</h3>
            ...
            {userTokens.slice(0, 4).map((token, index) => (
              <div key={index} className="bg-space-light/50 rounded-lg p-4 border border-white/10">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">{token.totalSupply?.toLocaleString()}</span>
                </div>
              </div>
            ))}
          </div>
